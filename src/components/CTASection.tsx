        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 mb-4 sm:mb-5 md:mb-6 px-2 sm:px-0">
              <Button variant="hero" size="default" className="group relative overflow-hidden w-full sm:w-auto">
                <motion.span
              ...
              <Button 
                ...
                asChild
              >
                {/* Update the phone number: Replace 1234567890 with your WhatsApp number (country code + number without + or spaces, e.g., 919876543210 for India) */}
                <a 
                  href="https://wa.me/1234567890?text=Hi%2C%20I%20would%20like%20to%20view%20your%20portfolio%20and%20discuss%20a%20project."
                  target="_blank"
